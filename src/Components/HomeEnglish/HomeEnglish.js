        ...
        <div className={styles.SortBoxs}>
          <div className={styles.SortP}>
            <p className={styles.StyleP}>
              This blog is a personal project with the purpose of making known
              more about me and my work, in this blog you will be able to see
              works that I have been part of and also those that I have done in
              a particular way, I hope you like it and do not hesitate to
              contact me.
            </p>
          </div>
        </div>
            ...
            <div className={styles.AboutMeBox}>
              <div className={styles.AboutMeDivBox}>
                <p className={styles.AboutMeP}>
                  I am passionate about development, trying to improve my work
                  and my skills every day, always with curiosity and impetus
                  looking for solutions to the problems that arise and learning
                  new things in this eternal path of study that is to be a
                  developer.
                </p>
              </div>
            </div>
        ...
        <Zoom className={styles.zoom}>
          <div className={styles.SkillsBox}>
            <p className={styles.PSkills}>
              About my skills I have had the opportunity to work with several
              technologies, mostly with Javascript,React, Express and MongoDB,
              although in the E-Commerce I have also worked with GraphQl,
              Typescript and Apollo, I think it is always good to learn and
              learn new tools to carry out projects that require a specific
              technology. Particularly in the case of this blog, although I
              don't have a great professional portfolio to show, I wanted to use
              it to show my skills in the management of React.
            </p>
          </div>
        </Zoom>
        <Zoom className={styles.zoom}>
            ...
            <Link className={styles.Link} to="/ProjectsE">
              <div className={styles.TwoLinks}>
                <div className={styles.AnyLink}>
                  <h4 className={styles.TitleClick}>See more projects</h4>
                </div>
                <div className={styles.AnyLink}>
                  <Folder
                ...
                <form onSubmit={handleSubmit}>
                  <div className={styles.FormGroup}>
                    <div className={styles.EachInput}>
                      <label className={styles.FomLabel}>Name</label>
                      <input
