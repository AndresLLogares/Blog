    ...
    <div className={styles.Back}>
      ...
      <div className={styles.SortAny}>
        <Zoom className={styles.zoom}>
          ...
          <div className={styles.SortInfoPro}>
            <p className={styles.Pinfo}>
              This is a small website that I did primarily to test Canva and
              drag and drop libraries which had generated me curiosity and the
              use of Pokémon API was more an excuse to make use of it. On the
              website you can also do the basic basic things like having an
              account, add your favorites, search Pokémons by name, and other
              things.
            </p>
          </div>
          <div className={styles.SortLitleLinks}>
      ...
      <div className={styles.SortAny}>
        <Zoom className={styles.zoom}>
          ...
          <div className={styles.SortInfoPro}>
            <p className={styles.Pinfo}>
              In this case I made a social network by recommendation of some
